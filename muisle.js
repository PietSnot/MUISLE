...
function nieuwSpel(metToetsenbord) {
    ...
    aantalWoorden = speeldata.aantalPogingen;
    console.log('woordlengte: ' + speeldata.geefWoordlengte());
    speeldata.nieuwSpel(speeldata.nieuweWoordlengte);   // maakt het veld 'huidigeWoordlengte gelijk aan het veld nieuweWoordlengte
...
function pasSpeelveldCSSAan() {
    ...
    else if (woordlengte === 8) format += ' auto auto auto';
...
function procesNieuweWoordlengte() {
    ...
    console.log('nieuwe lengte gekozen: ' + nieuweLengte);
    speeldata.zetNieuweWoordlengte(nieuweLengte);
    console.log('nieuwe woordlengte gezet: ' + speeldata.nieuweWoordlengte);
}
